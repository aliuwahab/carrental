                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-green-300 transition-all duration-300 hover:shadow-xl">
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-600 mb-6">Contact us to arrange payment</p>
                                        @php
                                            $whatsappNumber = str_replace(['+', ' ', '-', '(', ')'], '', \App\Models\Setting::get('whatsapp_contact', '+233546418092'));
                                            $whatsappMessage = urlencode("Hi, I want to arrange payment for the car {$booking->vehicle->name} with booking {$booking->booking_code}. Amount: $" . number_format($booking->total_amount, 2));
                                            $whatsappLink = "https://wa.me/{$whatsappNumber}?text={$whatsappMessage}";
                                        @endphp
                                        <a href="{{ $whatsappLink }}" 
                                           target="_blank"
                                           class="w-full bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-green-700 transition-all duration-300 font-bold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 inline-flex items-center justify-center">
